...
<div class="pad10">
 ...
 <div class="form-group" id="chosen-field">
  ...
  <div class="form-group" style="margin-top: 30px">
    <label style="padding-right:10px;" ><?php echo t("Show Description on addon item")?></label>
    <?php 
  ...
  <div class="form-group" style="margin-top: 30px">
    <label style="padding-right:10px;" ><?php echo t("Activate Menu 1")?></label>
    <?php 
    ...
    ?>
    <p class="text-muted"><?php echo t("this menu options display only food name and price")?></p>
  </div>
    
  
  <div class="form-group" style="margin-top: 30px">
    <label style="padding-right:10px;"><?php echo t("Save cart to database")?></label>
    <?php 
    ...
    ?>    
    <p class="text-muted"><?php echo t("this options will save the cart on database instead on device")?></p>
  </div>

    ...
    class AjaxAdmin extends DbExt {
        ...
        public function addMerchant() {
            ...
            if (!empty($this->data['restaurant_slug'])) {
                $params['restaurant_slug'] = FunctionsV3::verifyMerchantSlug(
                                Yii::app()->functions->seo_friendly_url($this->data['restaurant_slug']), $this->data['id']
                );
            } else {
            ...
            if (isset($this->data['package_id'])) {
                if ($package = Yii::app()->functions->getPackagesById($this->data['package_id'])) {
                    if ($package['promo_price'] >= 1) {
                        ...
                        $params['package_price'] = $package['price'];
                }
            }
            ...
            if (empty($this->data['id'])) {
                if ($this->insertData("{{merchant}}", $params)) {
                    ...
                    $mtid = $this->details;
                    Yii::app()->functions->updateOption("merchant_switch_master_cod", isset($this->data['merchant_switch_master_cod']) ? $this->data['merchant_switch_master_cod'] : ''
                            , $mtid);

                    Yii::app()->functions->updateOption("merchant_switch_master_ccr", isset($this->data['merchant_switch_master_ccr']) ? $this->data['merchant_switch_master_ccr'] : ''
                            , $mtid);

                    Yii::app()->functions->updateOption("merchant_switch_master_pyr", isset($this->data['merchant_switch_master_pyr']) ? $this->data['merchant_switch_master_pyr'] : ''
                            , $mtid);

                    Yii::app()->functions->updateOption("merchant_latitude", isset($this->data['merchant_latitude']) ? $this->data['merchant_latitude'] : ''
                            , $mtid);

                    Yii::app()->functions->updateOption("merchant_longtitude", isset($this->data['merchant_longtitude']) ? $this->data['merchant_longtitude'] : ''
                            , $mtid);
                }
            } else {
        ...
        public function rowDelete() {
            ...
            if ($this->data['tbl'] == "merchantSponsoredList") {
                ...
                if ($this->updateData("{{merchant}}", $params, 'merchant_id', $this->data['row_id'])) {
                    ...
                    $this->msg = Yii::t("default", "ERROR: cannot execute query.");
                return;
            }
        ...
        public function merchantLogin() {
            ...
            if ($res = $this->rst($stmt)) {
                if ($res[0]['status'] == "active" || $res[0]['status'] == "expired") {
                    ...
                    $this->msg = Yii::t("default", "Login Failed. You account status is " . $res[0]['status']);
            } else {
                //$this->msg=Yii::t("default","Either username or password is invalid.");
        ...
        public function uploadImage() {
            ...
            if (isset($this->data['qqfile']) && !empty($this->data['qqfile'])) {
                ...
                $this->msg = Yii::t("default", "File is empty");
        }
        ...
        public function addCategory() {
            ...
            if (isset($this->data['category_name_trans'])) {
                if (okToDecode()) {
                    $params['category_name_trans'] = json_encode($this->data['category_name_trans'], JSON_UNESCAPED_UNICODE);
                } else
                    $params['category_name_trans'] = json_encode($this->data['category_name_trans']);
            }
            if (isset($this->data['category_description_trans'])) {
                if (okToDecode()) {
                    $params['category_description_trans'] = json_encode($this->data['category_description_trans'], JSON_UNESCAPED_UNICODE);
                } else
            ...
            if (isset($this->data['id']) && is_numeric($this->data['id'])) {
                unset($params['date_created']);
                $params['date_modified'] = date('c');
                $res = $command->update('{{category}}', $params, 'cat_id=:cat_id', array(':cat_id' => addslashes($this->data['id'])));
                if ($res) {
                    $this->code = 1;
        ...
        public function addAddOnCategory() {
            ...
            if (isset($this->data['subcategory_name_trans'])) {
                if (okToDecode()) {
                    $params['subcategory_name_trans'] = json_encode($this->data['subcategory_name_trans'], JSON_UNESCAPED_UNICODE);
            ...
            if (isset($this->data['id']) && is_numeric($this->data['id'])) {
                unset($params['date_created']);
                $params['date_modified'] = date('c');
                $res = $command->update('{{subcategory}}', $params, 'subcat_id=:subcat_id', array(':subcat_id' => addslashes($this->data['id'])));
                if ($res) {
                    $this->code = 1;
        ...
        public function addOnItemNew() {
            ...
            if (isset($this->data['sub_item_name_trans'])) {
                if (okToDecode()) {
                    $params['sub_item_name_trans'] = json_encode($this->data['sub_item_name_trans'], JSON_UNESCAPED_UNICODE);
                } else
                    $params['sub_item_name_trans'] = json_encode($this->data['sub_item_name_trans']);
            }
            if (isset($this->data['item_description_trans'])) {
                if (okToDecode()) {
                    $params['item_description_trans'] = json_encode($this->data['item_description_trans'], JSON_UNESCAPED_UNICODE);
                } else
            ...
            if (isset($this->data['id']) && is_numeric($this->data['id'])) {
                unset($params['date_created']);
                $params['date_modified'] = date('c');
                $res = $command->update('{{subcategory_item}}', $params, 'sub_item_id=:sub_item_id', array(':sub_item_id' => addslashes($this->data['id'])));
                if ($res) {
                    $this->code = 1;
        ...
        public function AddSize() {
            ...
            if (isset($this->data['size_name_trans'])) {
                if (okToDecode()) {
                    $params['size_name_trans'] = json_encode($this->data['size_name_trans'], JSON_UNESCAPED_UNICODE);
                } else
            ...
            if (isset($this->data['id']) && is_numeric($this->data['id'])) {
                unset($params['date_created']);
                $params['date_modified'] = date('c');
                $res = $command->update('{{size}}', $params, 'size_id=:size_id', array(':size_id' => addslashes($this->data['id'])));
                if ($res) {
                    $this->code = 1;
        ...
        public function AddCookingRef() {
            ...
            if (isset($this->data['cooking_name_trans'])) {
                if (okToDecode()) {
                    $params['cooking_name_trans'] = json_encode($this->data['cooking_name_trans'], JSON_UNESCAPED_UNICODE);
                } else
            ...
            if (isset($this->data['id']) && is_numeric($this->data['id'])) {
                unset($params['date_created']);
                $params['date_modified'] = date('c');
                $res = $command->update('{{cooking_ref}}', $params, 'cook_id=:cook_id', array(':cook_id' => addslashes($this->data['id'])));
                if ($res) {
                    $this->code = 1;
        ...
        public function FoodItemAdd() {
            ...
            if (isset($this->data['item_name_trans'])) {
                if (okToDecode()) {
                    $params['item_name_trans'] = json_encode($this->data['item_name_trans'], JSON_UNESCAPED_UNICODE);
                } else
            ...
            if (isset($this->data['id']) && is_numeric($this->data['id'])) {
                unset($params['date_created']);
                $params['date_modified'] = date('c');
                $res = $command->update('{{item}}', $params, 'item_id=:item_id', array(':item_id' => addslashes($this->data['id'])));
                if ($res) {
                    $this->code = 1;
            ...
            if (is_array($rows) && count($rows) >= 1) {
                foreach ($rows as $val) {
                    ...
                    $feed_data['aaData'][] = array(
                        ...
                        $price_list,
                        $photo,
                        CHtml::checkBox('food_not_available', $val['not_available'] == 2 ? true : false, array(
                            'class' => 'not_available',
                            'value' => $val['item_id']
                        )),
                        $date . "<div>" . Yii::t("default", $val['status']) . "</div>"
        ...
        public function UpdateMerchant() {
            ...
            Yii::app()->functions->updateOption("merchant_information", isset($this->data['merchant_information']) ? $this->data['merchant_information'] : ''
                    , $merchant_id);
        ...
        public function merchantSettings() {
            ...
            Yii::app()->functions->updateOption("merchant_minimum_order", isset($this->data['merchant_minimum_order']) ? $this->data['merchant_minimum_order'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_tax", isset($this->data['merchant_tax']) ? $this->data['merchant_tax'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_delivery_charges", isset($this->data['merchant_delivery_charges']) ? $this->data['merchant_delivery_charges'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("stores_open_day", isset($this->data['stores_open_day']) ? json_encode($this->data['stores_open_day']) : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("stores_open_starts", isset($this->data['stores_open_starts']) ? json_encode($this->data['stores_open_starts']) : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("stores_open_ends", isset($this->data['stores_open_ends']) ? json_encode($this->data['stores_open_ends']) : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("stores_open_custom_text", isset($this->data['stores_open_custom_text']) ? json_encode($this->data['stores_open_custom_text']) : ''
                    , $merchant_id);

            //if (isset($this->data['photo'])){
            Yii::app()->functions->updateOption("merchant_photo", isset($this->data['photo']) ? $this->data['photo'] : ''
                    , $merchant_id);
            //}


            Yii::app()->functions->updateOption("merchant_delivery_estimation", isset($this->data['merchant_delivery_estimation']) ? $this->data['merchant_delivery_estimation'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_delivery_miles", isset($this->data['merchant_delivery_miles']) ? $this->data['merchant_delivery_miles'] : ''
                    , $merchant_id);
            ...
            Yii::app()->functions->updateOption("merchant_photo_bg", isset($this->data['photo2']) ? $this->data['photo2'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_disabled_cod", isset($this->data['merchant_disabled_cod']) ? $this->data['merchant_disabled_cod'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_disabled_ccr", isset($this->data['merchant_disabled_ccr']) ? $this->data['merchant_disabled_ccr'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_extenal", isset($this->data['merchant_extenal']) ? $this->data['merchant_extenal'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_enabled_voucher", isset($this->data['merchant_enabled_voucher']) ? $this->data['merchant_enabled_voucher'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_distance_type", isset($this->data['merchant_distance_type']) ? $this->data['merchant_distance_type'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_timezone", isset($this->data['merchant_timezone']) ? $this->data['merchant_timezone'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_close_msg", isset($this->data['merchant_close_msg']) ? $this->data['merchant_close_msg'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_preorder", isset($this->data['merchant_preorder']) ? $this->data['merchant_preorder'] : ''
                    , $merchant_id);
            ...
            Yii::app()->functions->updateOption("merchant_maximum_order", isset($this->data['merchant_maximum_order']) ? $this->data['merchant_maximum_order'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_packaging_charge", isset($this->data['merchant_packaging_charge']) ? $this->data['merchant_packaging_charge'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_close_msg_holiday", isset($this->data['merchant_close_msg_holiday']) ? $this->data['merchant_close_msg_holiday'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_holiday", isset($this->data['merchant_holiday']) ? json_encode($this->data['merchant_holiday']) : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_activated_menu", isset($this->data['merchant_activated_menu']) ? $this->data['merchant_activated_menu'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("spicydish", isset($this->data['spicydish']) ? $this->data['spicydish'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_required_delivery_time", isset($this->data['merchant_required_delivery_time']) ? $this->data['merchant_required_delivery_time'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_close_store", isset($this->data['merchant_close_store']) ? $this->data['merchant_close_store'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_packaging_increment", isset($this->data['merchant_packaging_increment']) ? $this->data['merchant_packaging_increment'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_show_time", isset($this->data['merchant_show_time']) ? $this->data['merchant_show_time'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_enabled_tip", isset($this->data['merchant_enabled_tip']) ? $this->data['merchant_enabled_tip'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_tip_default", isset($this->data['merchant_tip_default']) ? $this->data['merchant_tip_default'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_minimum_order_pickup", isset($this->data['merchant_minimum_order_pickup']) ? $this->data['merchant_minimum_order_pickup'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_maximum_order_pickup", isset($this->data['merchant_maximum_order_pickup']) ? $this->data['merchant_maximum_order_pickup'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_disabled_ordering", isset($this->data['merchant_disabled_ordering']) ? $this->data['merchant_disabled_ordering'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_tax_charges", isset($this->data['merchant_tax_charges']) ? $this->data['merchant_tax_charges'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("stores_open_pm_start", isset($this->data['stores_open_pm_start']) ? json_encode($this->data['stores_open_pm_start']) : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("stores_open_pm_ends", isset($this->data['stores_open_pm_ends']) ? json_encode($this->data['stores_open_pm_ends']) : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("food_option_not_available", isset($this->data['food_option_not_available']) ? $this->data['food_option_not_available'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("order_verification", isset($this->data['order_verification']) ? $this->data['order_verification'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("order_sms_code_waiting", isset($this->data['order_sms_code_waiting']) ? $this->data['order_sms_code_waiting'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("disabled_food_gallery", isset($this->data['disabled_food_gallery']) ? $this->data['disabled_food_gallery'] : ''
                    , $merchant_id);
        ...
        public function AlertSettings() {
            ...
            Yii::app()->functions->updateOption("merchant_notify_email", isset($this->data['merchant_notify_email']) ? $this->data['merchant_notify_email'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("enabled_alert_notification", isset($this->data['enabled_alert_notification']) ? $this->data['enabled_alert_notification'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("enabled_alert_sound", isset($this->data['enabled_alert_sound']) ? $this->data['enabled_alert_sound'] : ''
                    , $merchant_id);
        ...
        public function socialSettings() {
            ...
            Yii::app()->functions->updateOption("facebook_page", isset($this->data['facebook_page']) ? $this->data['facebook_page'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("twitter_page", isset($this->data['twitter_page']) ? $this->data['twitter_page'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("google_page", isset($this->data['google_page']) ? $this->data['google_page'] : ''
                    , $merchant_id);
        ...
        public function addToCart() {
            ...
            if (isset($this->data['item_id'])) {
                ...
                $this->msg = Yii::t("default", "Item id is required");
        }
        ...
        public function addCreditCard() {
            ...
            if (!Yii::app()->functions->getCCbyCard($this->data['credit_card_number'], $cid)) {
                ...
                $this->msg = Yii::t("default", "Credit card number already exist in you credit card list");
        }
            ...
            if (empty($client_id)) {
                if ($this->data['is_guest_checkout'] == 2) {
                    if (empty($_SESSION['guest_client_id'])) {
                        ...
                        $client_id = $_SESSION['guest_client_id'];
                }
            }
            ...
            if (Yii::app()->functions->clientAutoLogin($this->data['username'], $this->data['password'], $this->data['password_md5'])) {
                ...
                if ($res = FunctionsV3::login($this->data['username'], $this->data['password'])) {
                    if (strlen($res['mobile_verification_code']) >= 2 && $res['status'] == 'pending') {
                        ...
                        $this->msg = Yii::t("default", "Login Failed. Either username or password is incorrect");
                } else
                    $this->msg = Yii::t("default", "Login Failed. Either username or password is incorrect");
            }
        }
        ...
        public function placeOrder() {
            ...
            if (isset($this->data['client_order_sms_code'])) {
                if (!empty($this->data['client_order_sms_code'])) {
                    if (!FunctionsK::validateOrderSMSCode($this->data['contact_phone'], $this->data['client_order_sms_code'], $this->data['client_order_session'])) {
            ...
            if (isset($this->data['is_guest_checkout'])) {
                ...
                if (!$res_check = Yii::app()->functions->isClientExist($this->data['email_address'])) {
                    ...
                    if ($this->insertData("{{client}}", $params)) {
                        ...
                        $Validator->msg[] = t("Something went wrong during processing your request. Please try again later.");
                } else
                    $Validator->msg[] = t("Sorry but your email address already exist in our records.");
            ...
            if (is_array($order_item) && count($order_item) >= 1) {
                ...
                switch ($this->data['payment_opt']) {
                    case "pyp":
                        if (Yii::app()->functions->isMerchantCommission($this->data['merchant_id'])) {
                            ...
                            $card_fee = Yii::app()->functions->getOption('merchant_paypal_fee', $this->data['merchant_id']);
                        }
                        break;
                    default:
                        break;
                ...
                if (Yii::app()->functions->code == 1) {
                    ...
                    if (is_array($raw) && count($raw) >= 1) {
                        ...
                        if (Yii::app()->functions->getOptionAdmin('website_enabled_map_address') == 2) {
                            if (isset($this->data['map_address_toogle'])) {
                                if ($this->data['map_address_toogle'] == 2) {
                                    ...
                                    $geo_res = FunctionsV3::latToAdress($this->data['map_address_lat'], $this->data['map_address_lng']);
                                    if ($geo_res) {
                        ...
                        if ($this->insertData("{{order}}", $params)) {
                            ...
                            if (FunctionsV3::hasModuleAddon("pointsprogram")) {
                                PointsProgram::saveEarnPoints(
                                        isset($_SESSION['pts_earn']) ? $_SESSION['pts_earn'] : '', Yii::app()->functions->getClientId(), $this->data['merchant_id'], $order_id, $this->data['payment_opt']
                                );

                                if (isset($_SESSION['pts_redeem_points'])) {
                                    PointsProgram::saveExpensesPoints(
                                            $_SESSION['pts_redeem_points'], $_SESSION['pts_redeem_amt'], Yii::app()->functions->getClientId(), $this->data['merchant_id'], $order_id, $this->data['payment_opt']
                                    );
                                }
                            }
                            ...
                            if ($this->data['delivery_type'] == "delivery") {
                                ...
                                $this->updateData("{{client}}", $params_mobile, 'client_id', Yii::app()->functions->getClientId());
                            }
                            ...
                            /* VOUCHER */
                            if ($has_voucher == TRUE) {
                                Yii::app()->functions->updateVoucher($_SESSION['voucher_code']['voucher_name'], Yii::app()->functions->getClientId(), $order_id);
                            }
                        ...
                        $this->msg = Yii::t("default", "ERROR: Something went wrong");
                } else
                    $this->msg = Yii::app()->functions->msg;
            } else
                $this->msg = Yii::t("default", "Sorry but your order is empty");
        }
        ...
        public function addRating() {
            ...
            if (Yii::app()->functions->isClientLogin()) {
                ...
                $this->msg = Yii::t("default", "Sorry but you need to login before you can make a rating.");
        }
        ...
        public function removeRating() {
            if (Yii::app()->functions->isClientLogin()) {
                ...
                $this->msg = Yii::t("default", "Cannot remove ratings user is not login.");
        }
        ...
        public function loadRatings() {
            ...
            if ($ratings = Yii::app()->functions->getRatings($this->data['merchant_id'])) {
                ...
                $this->msg = Yii::t("default", "Ratings not available.");
        }
        ...
        public function loadReviews() {
            ...
            if ($res = Yii::app()->functions->getReviewsList($this->data['merchant_id'])) {
                ...
                $this->msg = Yii::t("default", "No reviews yet.");
        }

        public function savePaypalSettings() {
            $merchant_id = Yii::app()->functions->getMerchantID();

            Yii::app()->functions->updateOption("enabled_paypal", isset($this->data['enabled_paypal']) ? $this->data['enabled_paypal'] : '', $merchant_id);

            Yii::app()->functions->updateOption("paypal_mode", isset($this->data['paypal_mode']) ? $this->data['paypal_mode'] : '', $merchant_id);

            Yii::app()->functions->updateOption("sanbox_paypal_user", isset($this->data['sanbox_paypal_user']) ? $this->data['sanbox_paypal_user'] : '', $merchant_id);

            Yii::app()->functions->updateOption("sanbox_paypal_pass", isset($this->data['sanbox_paypal_pass']) ? $this->data['sanbox_paypal_pass'] : '', $merchant_id);

            Yii::app()->functions->updateOption("sanbox_paypal_signature", isset($this->data['sanbox_paypal_signature']) ? $this->data['sanbox_paypal_signature'] : '', $merchant_id);

            Yii::app()->functions->updateOption("live_paypal_user", isset($this->data['live_paypal_user']) ? $this->data['live_paypal_user'] : '', $merchant_id);

            Yii::app()->functions->updateOption("live_paypal_pass", isset($this->data['live_paypal_pass']) ? $this->data['live_paypal_pass'] : '', $merchant_id);

            Yii::app()->functions->updateOption("live_paypal_signature", isset($this->data['live_paypal_signature']) ? $this->data['live_paypal_signature'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_paypal_fee", isset($this->data['merchant_paypal_fee']) ? $this->data['merchant_paypal_fee'] : '', $merchant_id);

            Yii::app()->functions->updateOption("mt_paypal_mobile_enabled", isset($this->data['mt_paypal_mobile_enabled']) ? $this->data['mt_paypal_mobile_enabled'] : '', $merchant_id);

            Yii::app()->functions->updateOption("mt_paypal_mobile_mode", isset($this->data['mt_paypal_mobile_mode']) ? $this->data['mt_paypal_mobile_mode'] : '', $merchant_id);

            Yii::app()->functions->updateOption("mt_paypal_mobile_clientid", isset($this->data['mt_paypal_mobile_clientid']) ? $this->data['mt_paypal_mobile_clientid'] : '', $merchant_id);
        ...
        public function updateReview() {
            ...
            if ($DbExt->updateData("{{review}}", $params, 'id', $this->data['id'])) {
                ...
                $this->msg = Yii::t("default", "ERROR: cannot update reviews.");
        }
        ...
        public function deleteReview() {
            ...
            if ($DbExt->qry($stmt)) {
                ...
                $this->msg = Yii::t("default", "ERROR: Failed deleting reviews.");
        }
        ...
        public function paypalCheckoutPayment() {
            if (!empty($this->data['payerid']) && !empty($this->data['payerid'])) {
                ...
                if ($res = $paypal->expressCheckout()) {
                    ...
                    $command = Yii::app()->db->createCommand();
                    $command->update('{{paypal_checkout}}', $params, 'token=:token', array(':token' => addslashes($this->data['token'])));

                    $params = array('status' => 'paid');
                    $command->update('{{order}}', $params, 'order_id=:order_id', array(':order_id' => addslashes($this->data['order_id'])));
                ...
                $this->msg = Yii::t("default", "ERROR: One or more field is missing.");
        }
        ...
        public function addToOrder() {
            if (isset($this->data['order_id'])) {
                ...
                $this->msg = Yii::t("default", "Missing Order id");
        }
        ...
        public function editOrder() {
            ...
            <?php if ($res = Yii::app()->functions->getOrderInfo($this->data['id'])): ?>
                ...
                <?php
                echo CHtml::dropDownList('status', $res['status'], (array) $status_list, array(
                ...
                <?php echo CHtml::submitButton('Submit', array('value' => Yii::t("default", 'Submit'), 'class' => "uk-button uk-form-width-medium uk-button-success"))
                ?>
                        </div>
                    </form> 
            <?php else: ?>
            ...
            if (isset($this->data['order_id'])) {
                ...
                if ($resp = Yii::app()->functions->verifyOrderIdByOwner($order_id, $merchant_id)) {
                    ...
                    if (is_numeric($can_edit) && !empty($can_edit)) {
                        ...
                        if ($base_option == 2) {
                            $date_created = date("Y-m-d", strtotime($resp['delivery_date'] . " " . $resp['delivery_time']));
                        } else
                    ...
                    if ($DbExt->updateData('{{order}}', $params, 'order_id', $order_id)) {
                        ...
                        $this->msg = Yii::t("default", "ERROR: cannot update order.");
                } else
                    $this->msg = Yii::t("default", "This Order does not belong to you.");
            } else
                $this->msg = Yii::t("default", "Missing parameters");
        }
            ...
            if ($res = $DbExt->rst($stmt)) {
                ...
                foreach ($res as $val) {
                    ...
                    $item = FunctionsV3::translateFoodItemByOrderId(
                                    $val['order_id'], 'kr_merchant_lang_id'
                    );
        ...
        public function orderStatusSettings() {
            ...
            Yii::app()->functions->updateOption("default_order_status", isset($this->data['default_order_status']) ? $this->data['default_order_status'] : ''
                    , $merchant_id);
        ...
        public function saveAdminPaypalSettings() {
            Yii::app()->functions->updateOptionAdmin("admin_enabled_paypal", isset($this->data['admin_enabled_paypal']) ? $this->data['admin_enabled_paypal'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_paypal_mode", isset($this->data['admin_paypal_mode']) ? $this->data['admin_paypal_mode'] : '' );

            Yii::app()->functions->updateOptionAdmin("admin_sanbox_paypal_user", isset($this->data['admin_sanbox_paypal_user']) ? $this->data['admin_sanbox_paypal_user'] : '' );

            Yii::app()->functions->updateOptionAdmin("admin_sanbox_paypal_pass", isset($this->data['admin_sanbox_paypal_pass']) ? $this->data['admin_sanbox_paypal_pass'] : '' );

            Yii::app()->functions->updateOptionAdmin("admin_sanbox_paypal_signature", isset($this->data['admin_sanbox_paypal_signature']) ? $this->data['admin_sanbox_paypal_signature'] : '' );

            Yii::app()->functions->updateOptionAdmin("admin_live_paypal_user", isset($this->data['admin_live_paypal_user']) ? $this->data['admin_live_paypal_user'] : '' );

            Yii::app()->functions->updateOptionAdmin("admin_live_paypal_pass", isset($this->data['admin_live_paypal_pass']) ? $this->data['admin_live_paypal_pass'] : '' );

            Yii::app()->functions->updateOptionAdmin("admin_live_paypal_signature", isset($this->data['admin_live_paypal_signature']) ? $this->data['admin_live_paypal_signature'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_paypal_fee", isset($this->data['admin_paypal_fee']) ? $this->data['admin_paypal_fee'] : '');

            Yii::app()->functions->updateOptionAdmin("adm_paypal_mobile_enabled", isset($this->data['adm_paypal_mobile_enabled']) ? $this->data['adm_paypal_mobile_enabled'] : '');

            Yii::app()->functions->updateOptionAdmin("adm_paypal_mobile_mode", isset($this->data['adm_paypal_mobile_mode']) ? $this->data['adm_paypal_mobile_mode'] : '');

            Yii::app()->functions->updateOptionAdmin("adm_paypal_mobile_clientid", isset($this->data['adm_paypal_mobile_clientid']) ? $this->data['adm_paypal_mobile_clientid'] : '');
        ...
        public function adminSettings() {
            ...
            Yii::app()->functions->updateOptionAdmin("website_disbaled_auto_cart", isset($this->data['website_disbaled_auto_cart']) ? $this->data['website_disbaled_auto_cart'] : '');

            Yii::app()->functions->updateOptionAdmin("website_enabled_mobile_verification", isset($this->data['website_enabled_mobile_verification']) ? $this->data['website_enabled_mobile_verification'] : '');

            Yii::app()->functions->updateOptionAdmin("website_date_picker_format", isset($this->data['website_date_picker_format']) ? $this->data['website_date_picker_format'] : '');

            Yii::app()->functions->updateOptionAdmin("website_time_picker_format", isset($this->data['website_time_picker_format']) ? $this->data['website_time_picker_format'] : '');

            Yii::app()->functions->updateOptionAdmin("website_date_format", isset($this->data['website_date_format']) ? $this->data['website_date_format'] : '');

            Yii::app()->functions->updateOptionAdmin("website_time_format", isset($this->data['website_time_format']) ? $this->data['website_time_format'] : '');

            Yii::app()->functions->updateOptionAdmin("merchant_sigup_status", isset($this->data['merchant_sigup_status']) ? $this->data['merchant_sigup_status'] : '');

            Yii::app()->functions->updateOptionAdmin("merchant_email_verification", isset($this->data['merchant_email_verification']) ? $this->data['merchant_email_verification'] : '' );

            Yii::app()->functions->updateOptionAdmin("merchant_payment_enabled", isset($this->data['merchant_payment_enabled']) ? $this->data['merchant_payment_enabled'] : '' );

            Yii::app()->functions->updateOptionAdmin("admin_enabled_paypal", isset($this->data['admin_enabled_paypal']) ? $this->data['admin_enabled_paypal'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_enabled_card", isset($this->data['admin_enabled_card']) ? $this->data['admin_enabled_card'] : '' );

            Yii::app()->functions->updateOptionAdmin("admin_country_set", isset($this->data['admin_country_set']) ? $this->data['admin_country_set'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_currency_set", isset($this->data['admin_currency_set']) ? $this->data['admin_currency_set'] : '');

            Yii::app()->functions->updateOptionAdmin("home_search_text", isset($this->data['home_search_text']) ? $this->data['home_search_text'] : '' );

            Yii::app()->functions->updateOptionAdmin("home_search_subtext", isset($this->data['home_search_subtext']) ? $this->data['home_search_subtext'] : '' );

            Yii::app()->functions->updateOptionAdmin("home_search_mode", isset($this->data['home_search_mode']) ? $this->data['home_search_mode'] : '' );


            Yii::app()->functions->updateOptionAdmin("website_logo", isset($this->data['photo']) ? $this->data['photo'] : '' );

            Yii::app()->functions->updateOptionAdmin("website_title", isset($this->data['website_title']) ? $this->data['website_title'] : '' );

            Yii::app()->functions->updateOptionAdmin("website_address", isset($this->data['website_address']) ? $this->data['website_address'] : '' );

            Yii::app()->functions->updateOptionAdmin("website_contact_phone", isset($this->data['website_contact_phone']) ? $this->data['website_contact_phone'] : '' );

            Yii::app()->functions->updateOptionAdmin("website_contact_email", isset($this->data['website_contact_email']) ? $this->data['website_contact_email'] : '' );

            Yii::app()->functions->updateOptionAdmin("admin_decimal_place", isset($this->data['admin_decimal_place']) ? $this->data['admin_decimal_place'] : '' );

            Yii::app()->functions->updateOptionAdmin("admin_use_separators", isset($this->data['admin_use_separators']) ? $this->data['admin_use_separators'] : '' );

            Yii::app()->functions->updateOptionAdmin("google_auto_address", isset($this->data['google_auto_address']) ? $this->data['google_auto_address'] : '' );

            Yii::app()->functions->updateOptionAdmin("home_search_radius", isset($this->data['home_search_radius']) ? $this->data['home_search_radius'] : '' );

            Yii::app()->functions->updateOptionAdmin("home_search_unit_type", isset($this->data['home_search_unit_type']) ? $this->data['home_search_unit_type'] : '' );

            Yii::app()->functions->updateOptionAdmin("google_default_country", isset($this->data['google_default_country']) ? $this->data['google_default_country'] : '' );

            Yii::app()->functions->updateOptionAdmin("enabled_advance_search", isset($this->data['enabled_advance_search']) ? $this->data['enabled_advance_search'] : '' );

            Yii::app()->functions->updateOptionAdmin("disabled_share_location", isset($this->data['disabled_share_location']) ? $this->data['disabled_share_location'] : '' );

            Yii::app()->functions->updateOptionAdmin("enabled_search_map", isset($this->data['enabled_search_map']) ? $this->data['enabled_search_map'] : '' );

            Yii::app()->functions->updateOptionAdmin("admin_currency_position", isset($this->data['admin_currency_position']) ? $this->data['admin_currency_position'] : '' );

            Yii::app()->functions->updateOptionAdmin("merchant_default_country", isset($this->data['merchant_default_country']) ? $this->data['merchant_default_country'] : '' );

            Yii::app()->functions->updateOptionAdmin("merchant_specific_country", isset($this->data['merchant_specific_country']) ? json_encode($this->data['merchant_specific_country']) : '' );

            Yii::app()->functions->updateOptionAdmin("map_marker", isset($this->data['photo2']) ? $this->data['photo2'] : '' );

            Yii::app()->functions->updateOptionAdmin("global_admin_sender_email", isset($this->data['global_admin_sender_email']) ? $this->data['global_admin_sender_email'] : '' );

            Yii::app()->functions->updateOptionAdmin("merchant_disabled_registration", isset($this->data['merchant_disabled_registration']) ? $this->data['merchant_disabled_registration'] : '' );

            Yii::app()->functions->updateOptionAdmin("disabled_subscription", isset($this->data['disabled_subscription']) ? $this->data['disabled_subscription'] : '' );

            Yii::app()->functions->updateOptionAdmin("disabled_featured_merchant", isset($this->data['disabled_featured_merchant']) ? $this->data['disabled_featured_merchant'] : '' );

            Yii::app()->functions->updateOptionAdmin("merchant_days_can_edit_status", isset($this->data['merchant_days_can_edit_status']) ? $this->data['merchant_days_can_edit_status'] : '' );

            Yii::app()->functions->updateOptionAdmin("disabled_website_ordering", isset($this->data['disabled_website_ordering']) ? $this->data['disabled_website_ordering'] : '' );

            Yii::app()->functions->updateOptionAdmin("admin_activated_menu", isset($this->data['admin_activated_menu']) ? $this->data['admin_activated_menu'] : '' );

            Yii::app()->functions->updateOptionAdmin("website_hide_foodprice", isset($this->data['website_hide_foodprice']) ? $this->data['website_hide_foodprice'] : '' );

            Yii::app()->functions->updateOptionAdmin("disabled_cc_management", isset($this->data['disabled_cc_management']) ? $this->data['disabled_cc_management'] : '' );

            Yii::app()->functions->updateOptionAdmin("merchant_reg_abn", isset($this->data['merchant_reg_abn']) ? $this->data['merchant_reg_abn'] : '' );

            Yii::app()->functions->updateOptionAdmin("spicydish", isset($this->data['spicydish']) ? $this->data['spicydish'] : '' );

            Yii::app()->functions->updateOptionAdmin("website_timezone", isset($this->data['website_timezone']) ? $this->data['website_timezone'] : '' );

            Yii::app()->functions->updateOptionAdmin("website_admin_mutiple_login", isset($this->data['website_admin_mutiple_login']) ? $this->data['website_admin_mutiple_login'] : '' );

            Yii::app()->functions->updateOptionAdmin("website_merchant_mutiple_login", isset($this->data['website_merchant_mutiple_login']) ? $this->data['website_merchant_mutiple_login'] : '' );

            Yii::app()->functions->updateOptionAdmin("website_disabled_guest_checkout", isset($this->data['website_disabled_guest_checkout']) ? $this->data['website_disabled_guest_checkout'] : '' );

            Yii::app()->functions->updateOptionAdmin("website_reviews_actual_purchase", isset($this->data['website_reviews_actual_purchase']) ? $this->data['website_reviews_actual_purchase'] : '' );

            Yii::app()->functions->updateOptionAdmin("website_terms_merchant", isset($this->data['website_terms_merchant']) ? $this->data['website_terms_merchant'] : '' );
            Yii::app()->functions->updateOptionAdmin("website_terms_merchant_url", isset($this->data['website_terms_merchant_url']) ? $this->data['website_terms_merchant_url'] : '' );

            Yii::app()->functions->updateOptionAdmin("website_terms_customer", isset($this->data['website_terms_customer']) ? $this->data['website_terms_customer'] : '' );
            Yii::app()->functions->updateOptionAdmin("website_terms_customer_url", isset($this->data['website_terms_customer_url']) ? $this->data['website_terms_customer_url'] : '' );

            Yii::app()->functions->updateOptionAdmin("admin_thousand_separator", isset($this->data['admin_thousand_separator']) ? $this->data['admin_thousand_separator'] : '' );

            Yii::app()->functions->updateOptionAdmin("admin_decimal_separator", isset($this->data['admin_decimal_separator']) ? $this->data['admin_decimal_separator'] : '' );

            Yii::app()->functions->updateOptionAdmin("website_disabled_login_popup", isset($this->data['website_disabled_login_popup']) ? $this->data['website_disabled_login_popup'] : '' );

            Yii::app()->functions->updateOptionAdmin("merchant_can_edit_reviews", isset($this->data['merchant_can_edit_reviews']) ? $this->data['merchant_can_edit_reviews'] : '' );

            Yii::app()->functions->updateOptionAdmin("website_enabled_rcpt", isset($this->data['website_enabled_rcpt']) ? $this->data['website_enabled_rcpt'] : '' );

            Yii::app()->functions->updateOptionAdmin("website_receipt_logo", isset($this->data['website_receipt_logo']) ? $this->data['website_receipt_logo'] : '' );

            Yii::app()->functions->updateOptionAdmin("disabled_cart_sticky", isset($this->data['disabled_cart_sticky']) ? $this->data['disabled_cart_sticky'] : '' );

            Yii::app()->functions->updateOptionAdmin("search_result_bydistance", isset($this->data['search_result_bydistance']) ? $this->data['search_result_bydistance'] : '' );

            Yii::app()->functions->updateOptionAdmin("google_geo_api_key", isset($this->data['google_geo_api_key']) ? $this->data['google_geo_api_key'] : '' );

            Yii::app()->functions->updateOptionAdmin("website_enabled_map_address", isset($this->data['website_enabled_map_address']) ? $this->data['website_enabled_map_address'] : '' );

            Yii::app()->functions->updateOptionAdmin("client_custom_field_name1", isset($this->data['client_custom_field_name1']) ? $this->data['client_custom_field_name1'] : '' );

            Yii::app()->functions->updateOptionAdmin("client_custom_field_name2", isset($this->data['client_custom_field_name2']) ? $this->data['client_custom_field_name2'] : '' );

            Yii::app()->functions->updateOptionAdmin("merchant_days_can_edit_status_basedon", isset($this->data['merchant_days_can_edit_status_basedon']) ? $this->data['merchant_days_can_edit_status_basedon'] : '' );

            Yii::app()->functions->updateOptionAdmin("merchant_status_disabled", isset($this->data['merchant_status_disabled']) ? $this->data['merchant_status_disabled'] : '' );

            Yii::app()->functions->updateOptionAdmin("view_map_disabled", isset($this->data['view_map_disabled']) ? $this->data['view_map_disabled'] : '' );

            Yii::app()->functions->updateOptionAdmin("view_map_default_zoom", isset($this->data['view_map_default_zoom']) ? $this->data['view_map_default_zoom'] : '' );

            Yii::app()->functions->updateOptionAdmin("view_map_default_zoom_s", isset($this->data['view_map_default_zoom_s']) ? $this->data['view_map_default_zoom_s'] : '' );

            Yii::app()->functions->updateOptionAdmin("receipt_default_subject", isset($this->data['receipt_default_subject']) ? $this->data['receipt_default_subject'] : '' );

            Yii::app()->functions->updateOptionAdmin("merchant_tbl_book_disabled", isset($this->data['merchant_tbl_book_disabled']) ? $this->data['merchant_tbl_book_disabled'] : '' );

            Yii::app()->functions->updateOptionAdmin("merchant_changeorder_sms", isset($this->data['merchant_changeorder_sms']) ? $this->data['merchant_changeorder_sms'] : '' );

            Yii::app()->functions->updateOptionAdmin("customer_ask_address", isset($this->data['customer_ask_address']) ? $this->data['customer_ask_address'] : '' );

            Yii::app()->functions->updateOptionAdmin("captcha_site_key", isset($this->data['captcha_site_key']) ? $this->data['captcha_site_key'] : '');

            Yii::app()->functions->updateOptionAdmin("captcha_secret", isset($this->data['captcha_secret']) ? $this->data['captcha_secret'] : '');

            Yii::app()->functions->updateOptionAdmin("captcha_lang", isset($this->data['captcha_lang']) ? $this->data['captcha_lang'] : '');

            Yii::app()->functions->updateOptionAdmin("captcha_customer_signup", isset($this->data['captcha_customer_signup']) ? $this->data['captcha_customer_signup'] : '');

            Yii::app()->functions->updateOptionAdmin("captcha_merchant_signup", isset($this->data['captcha_merchant_signup']) ? $this->data['captcha_merchant_signup'] : '');

            Yii::app()->functions->updateOptionAdmin("captcha_customer_login", isset($this->data['captcha_customer_login']) ? $this->data['captcha_customer_login'] : '');

            Yii::app()->functions->updateOptionAdmin("captcha_merchant_login", isset($this->data['captcha_merchant_login']) ? $this->data['captcha_merchant_login'] : '');

            Yii::app()->functions->updateOptionAdmin("captcha_admin_login", isset($this->data['captcha_admin_login']) ? $this->data['captcha_admin_login'] : '');

            Yii::app()->functions->updateOptionAdmin("captcha_order", isset($this->data['captcha_order']) ? $this->data['captcha_order'] : '');

            Yii::app()->functions->updateOptionAdmin("blocked_email_add", isset($this->data['blocked_email_add']) ? $this->data['blocked_email_add'] : '');

            Yii::app()->functions->updateOptionAdmin("blocked_mobile", isset($this->data['blocked_mobile']) ? $this->data['blocked_mobile'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_zipcode_searchtype", isset($this->data['admin_zipcode_searchtype']) ? $this->data['admin_zipcode_searchtype'] : '');

            Yii::app()->functions->updateOptionAdmin("mobilelogo", isset($this->data['mobilelogo']) ? $this->data['mobilelogo'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_enabled_email_verification", isset($this->data['theme_enabled_email_verification']) ? $this->data['theme_enabled_email_verification'] : '');

            Yii::app()->functions->updateOptionAdmin("google_distance_method", isset($this->data['google_distance_method']) ? $this->data['google_distance_method'] : '');

            Yii::app()->functions->updateOptionAdmin("google_use_curl", isset($this->data['google_use_curl']) ? $this->data['google_use_curl'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_menu_allowed_merchant", isset($this->data['admin_menu_allowed_merchant']) ? $this->data['admin_menu_allowed_merchant'] : '');
                ...
                if ($res = $this->rst($stmt)) {
                    if ($res[0]['status'] == "active") {
                        ...
                        if ($res[0]['activation_key'] == $this->data['activation_code']) {
                            ...
                            if ($package_info = FunctionsV3::getMerchantPaymentMembership($res[0]['merchant_id'], $res[0]['package_id'])) {
                            ...
                            $this->msg = Yii::t("default", "Invalid Activation code.");
                    }
                } else
                    $this->msg = Yii::t("default", "Sorry but we cannot find your information.");
            } else
                    ...
                    if (is_numeric($this->data['cc_id'])) {
                        ...
                        if (isset($this->data['renew'])) {
                            ...
                            if ($this->insertData("{{package_trans}}", $params)) {
                                ...
                                $this->updateData("{{merchant}}", array(
                                    'payment_steps' => 3,
                                    'membership_purchase_date' => date('c')
                                        )
                                        , 'merchant_id', $merchant['merchant_id']);
        ...
        public function merchantFreePayment() {
            ...
            $this->updateData("{{merchant}}", array('payment_steps' => 3), 'merchant_id', $merchant['merchant_id']);
        }
            ...
            if ($res = $DbExt->rst($stmt)) {
                foreach ($res as $val) {
                    ...
                    if ($val['payment_type'] == "ocr") {
                        ...
                        $payment_type = strtoupper(t($val['payment_type']));
        ...
        public function editPayment() {
            ...
            <?php if ($res = Yii::app()->functions->getMerchantPaymentByID($this->data['id'])): ?>
                ...
                ?>
                        ...
                        <div class="action-wrap">
                <?php echo CHtml::submitButton('Submit', array('class' => "uk-button uk-form-width-medium uk-button-success"))
                ?>
                        </div>
                    </form> 
            <?php else: ?>
        ...
        public function merchantPaymentPaypal() {
            ...
            if ($res_paypal = $paypal->getExpressDetail()) {
                ...
                if ($res = $paypal->expressCheckout()) {
                    ...
                    $this->updateData("{{merchant}}", array('payment_steps' => 3,
                        'membership_purchase_date' => date('c')
                            ), 'merchant_id', $merchant['merchant_id']);
                } else
                    $this->msg = $paypal->getError();
        ...
        public function updateMerchantStatus() {
            if (isset($this->data['id'])) {
                ...
                if ($this->updateData("{{merchant}}", $params, 'merchant_id', $this->data['id'])) {
                    ...
                    $this->msg = Yii::t("default", "Error; cannot update status.");
            } else
                $this->msg = Yii::t("default", "Missing parameters");
        }
        ...
        public function addCuisine() {
            ...
            if ($Validator->validate()) {
                ...
                if (isset($this->data['cuisine_name_trans'])) {
                    if (okToDecode()) {
                        $params['cuisine_name_trans'] = json_encode($this->data['cuisine_name_trans'], JSON_UNESCAPED_UNICODE);
                    } else
        ...
        public function updateClientProfile() {
            ...
            if ($this->updateData("{{client}}", $params, 'client_id', $client_id)) {
                ...
                $this->msg = Yii::t("default", "ERROR: cannot update profile.");
        }
        ...
        public function updateCreditCard() {
            ...
            if ($this->updateData("{{client_cc}}", $params, 'cc_id', $this->data['cc_id'])) {
                $this->code = 1;
                $this->msg = Yii::t("default", "Card successfully updated.");
            } else
                $this->msg = Yii::t("default", "ERROR: Cannot update credit card info.");
        }
        ...
        public function contactSettings() {
            ...
            if (is_array($this->data['contact_field']) && count($this->data['contact_field']) >= 1) {
                ...
                $this->msg = Yii::t("default", "Contact field must have 1 or more fields");
        }
        ...
        public function adminSocialSettings() {
            ...
            yii::app()->functions->updateOptionAdmin('google_client_id', isset($this->data['google_client_id']) ? $this->data['google_client_id'] : "");

            yii::app()->functions->updateOptionAdmin('google_client_secret', isset($this->data['google_client_secret']) ? $this->data['google_client_secret'] : "");

            yii::app()->functions->updateOptionAdmin('google_client_redirect_ulr', isset($this->data['google_client_redirect_ulr']) ? $this->data['google_client_redirect_ulr'] : "");

            yii::app()->functions->updateOptionAdmin('google_login_enabled', isset($this->data['google_login_enabled']) ? $this->data['google_login_enabled'] : "");

            yii::app()->functions->updateOptionAdmin('default_share_text', isset($this->data['default_share_text']) ? $this->data['default_share_text'] : "");

            yii::app()->functions->updateOptionAdmin('admin_intagram_page', isset($this->data['admin_intagram_page']) ? $this->data['admin_intagram_page'] : "");

            yii::app()->functions->updateOptionAdmin('admin_youtube_url', isset($this->data['admin_youtube_url']) ? $this->data['admin_youtube_url'] : "");
        ...
        public function FBRegister() {
            if (isset($this->data['email'])) {
                ...
                $this->msg = Yii::t("default", "Unexpected response. please login again.");
        }
        ...
        public function changePassword() {
            ...
            if ($Validator->validate()) {
                if ($res = Yii::app()->functions->getLostPassToken($this->data['token'])) {
                    ...
                    $this->msg = Yii::t("default", "ERROR: Cannot update password");
            } else
                $this->msg = Yii::t("default", "Token is missing");
        }
        ...
        public function merchantChangePassword() {
            if (isset($this->data['lost_password_code'])) {
                ...
                if ($res = $this->rst($stmt)) {
                    ...
                    $this->msg = Yii::t("default", "Sorry but your verification code is incorrect");
            } else
                $this->msg = Yii::t("default", "ERROR: missing parameters");
        }
            ...
            if ($Validator->validate()) {
                ...
                if (is_numeric($this->data['id'])) {
                    ...
                    if ($this->insertData("{{languages}}", $params)) {
                        ...
                        $this->msg = Yii::t("default", "Failed. cannot insert records");
                }
            } else {
        ...
        public function languageSettings() {
            ...
            yii::app()->functions->updateOptionAdmin('enabled_multiple_translation', isset($this->data['enabled_multiple_translation']) ? $this->data['enabled_multiple_translation'] : "");

            yii::app()->functions->updateOptionAdmin('default_language_backend', isset($this->data['default_language_backend']) ? $this->data['default_language_backend'] : "");

            yii::app()->functions->updateOptionAdmin('show_language_backend', isset($this->data['show_language_backend']) ? $this->data['show_language_backend'] : "");
        ...
        public function SeoSettings() {
            yii::app()->functions->updateOptionAdmin('seo_home', isset($this->data['seo_home']) ? $this->data['seo_home'] : "");

            yii::app()->functions->updateOptionAdmin('seo_home_meta', isset($this->data['seo_home_meta']) ? $this->data['seo_home_meta'] : "");

            yii::app()->functions->updateOptionAdmin('seo_home_keywords', isset($this->data['seo_home_keywords']) ? $this->data['seo_home_keywords'] : "");

            yii::app()->functions->updateOptionAdmin('seo_search', isset($this->data['seo_search']) ? $this->data['seo_search'] : "");
            yii::app()->functions->updateOptionAdmin('seo_search_meta', isset($this->data['seo_search_meta']) ? $this->data['seo_search_meta'] : "");
            yii::app()->functions->updateOptionAdmin('seo_search_keywords', isset($this->data['seo_search_keywords']) ? $this->data['seo_search_keywords'] : "");

            yii::app()->functions->updateOptionAdmin('seo_menu', isset($this->data['seo_menu']) ? $this->data['seo_menu'] : "");
            yii::app()->functions->updateOptionAdmin('seo_menu_meta', isset($this->data['seo_menu_meta']) ? $this->data['seo_menu_meta'] : "");
            yii::app()->functions->updateOptionAdmin('seo_menu_keywords', isset($this->data['seo_menu_keywords']) ? $this->data['seo_menu_keywords'] : "");

            yii::app()->functions->updateOptionAdmin('seo_checkout', isset($this->data['seo_checkout']) ? $this->data['seo_checkout'] : "");
            yii::app()->functions->updateOptionAdmin('seo_checkout_meta', isset($this->data['seo_checkout_meta']) ? $this->data['seo_checkout_meta'] : "");
            yii::app()->functions->updateOptionAdmin('seo_checkout_keywords', isset($this->data['seo_checkout_keywords']) ? $this->data['seo_checkout_keywords'] : "");

            yii::app()->functions->updateOptionAdmin('seo_contact', isset($this->data['seo_contact']) ? $this->data['seo_contact'] : "");
            yii::app()->functions->updateOptionAdmin('seo_contact_meta', isset($this->data['seo_contact_meta']) ? $this->data['seo_contact_meta'] : "");
            yii::app()->functions->updateOptionAdmin('seo_contact_keywords', isset($this->data['seo_contact_keywords']) ? $this->data['seo_contact_keywords'] : "");

            yii::app()->functions->updateOptionAdmin('seo_merchantsignup', isset($this->data['seo_merchantsignup']) ? $this->data['seo_merchantsignup'] : "");
            yii::app()->functions->updateOptionAdmin('seo_merchantsignup_meta', isset($this->data['seo_merchantsignup_meta']) ? $this->data['seo_merchantsignup_meta'] : "");
            yii::app()->functions->updateOptionAdmin('seo_merchantsignup_keywords', isset($this->data['seo_merchantsignup_keywords']) ? $this->data['seo_merchantsignup_keywords'] : "");
        ...
        public function receiptSettings() {
            ...
            Yii::app()->functions->updateOption("receipt_sender", isset($this->data['receipt_sender']) ? $this->data['receipt_sender'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("receipt_subject", isset($this->data['receipt_subject']) ? $this->data['receipt_subject'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("receipt_content", isset($this->data['receipt_content']) ? $this->data['receipt_content'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_receipt_subject", isset($this->data['merchant_receipt_subject']) ? $this->data['merchant_receipt_subject'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_receipt_content", isset($this->data['merchant_receipt_content']) ? $this->data['merchant_receipt_content'] : ''
                    , $merchant_id);
        ...
        public function removeMerchantBg() {
            if (Yii::app()->functions->isMerchantLogin()) {
                ...
                $this->code = 1;
                $this->msg = Yii::t("default", "Merchant background has been removed");
            } else
                $this->msg = Yii::t("default", "ERROR: Your session has expired.");
        }
        ...
        public function stripeSettings() {
            ...
            Yii::app()->functions->updateOption("stripe_enabled", isset($this->data['stripe_enabled']) ? $this->data['stripe_enabled'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("stripe_mode", isset($this->data['stripe_mode']) ? $this->data['stripe_mode'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("stripe_enabled", isset($this->data['stripe_enabled']) ? $this->data['stripe_enabled'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("sanbox_stripe_secret_key", isset($this->data['sanbox_stripe_secret_key']) ? $this->data['sanbox_stripe_secret_key'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("sandbox_stripe_pub_key", isset($this->data['sandbox_stripe_pub_key']) ? $this->data['sandbox_stripe_pub_key'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("live_stripe_secret_key", isset($this->data['live_stripe_secret_key']) ? $this->data['live_stripe_secret_key'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("live_stripe_pub_key", isset($this->data['live_stripe_pub_key']) ? $this->data['live_stripe_pub_key'] : ''
                    , $merchant_id);
        ...
        public function adminStripeSettings() {
            ...
            Yii::app()->functions->updateOptionAdmin("admin_stripe_enabled", isset($this->data['admin_stripe_enabled']) ? $this->data['admin_stripe_enabled'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_stripe_mode", isset($this->data['admin_stripe_mode']) ? $this->data['admin_stripe_mode'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_stripe_enabled", isset($this->data['admin_stripe_enabled']) ? $this->data['admin_stripe_enabled'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_sanbox_stripe_secret_key", isset($this->data['admin_sanbox_stripe_secret_key']) ? $this->data['admin_sanbox_stripe_secret_key'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_sandbox_stripe_pub_key", isset($this->data['admin_sandbox_stripe_pub_key']) ? $this->data['admin_sandbox_stripe_pub_key'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_live_stripe_secret_key", isset($this->data['admin_live_stripe_secret_key']) ? $this->data['admin_live_stripe_secret_key'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_live_stripe_pub_key", isset($this->data['admin_live_stripe_pub_key']) ? $this->data['admin_live_stripe_pub_key'] : '');
        ...
        public function smsSettings() {
            Yii::app()->functions->updateOptionAdmin("sms_sender_id", isset($this->data['sms_sender_id']) ? $this->data['sms_sender_id'] : '');

            Yii::app()->functions->updateOptionAdmin("sms_account_id", isset($this->data['sms_account_id']) ? $this->data['sms_account_id'] : '');

            Yii::app()->functions->updateOptionAdmin("sms_token", isset($this->data['sms_token']) ? $this->data['sms_token'] : '');

            Yii::app()->functions->updateOptionAdmin("mechant_sms_enabled", isset($this->data['mechant_sms_enabled']) ? $this->data['mechant_sms_enabled'] : '');

            Yii::app()->functions->updateOptionAdmin("mechant_sms_enabled", isset($this->data['mechant_sms_enabled']) ? $this->data['mechant_sms_enabled'] : '');

            Yii::app()->functions->updateOptionAdmin("sms_provider", isset($this->data['sms_provider']) ? $this->data['sms_provider'] : '');

            Yii::app()->functions->updateOptionAdmin("nexmo_sender_id", isset($this->data['nexmo_sender_id']) ? $this->data['nexmo_sender_id'] : '');

            Yii::app()->functions->updateOptionAdmin("nexmo_key", isset($this->data['nexmo_key']) ? $this->data['nexmo_key'] : '');

            Yii::app()->functions->updateOptionAdmin("nexmo_secret", isset($this->data['nexmo_secret']) ? $this->data['nexmo_secret'] : '');

            Yii::app()->functions->updateOptionAdmin("nexmo_use_curl", isset($this->data['nexmo_use_curl']) ? $this->data['nexmo_use_curl'] : '');

            Yii::app()->functions->updateOptionAdmin("privatesms_username", isset($this->data['privatesms_username']) ? $this->data['privatesms_username'] : '');

            Yii::app()->functions->updateOptionAdmin("privatesms_password", isset($this->data['privatesms_password']) ? $this->data['privatesms_password'] : '');

            Yii::app()->functions->updateOptionAdmin("privatesms_sender", isset($this->data['privatesms_sender']) ? $this->data['privatesms_sender'] : '');

            Yii::app()->functions->updateOptionAdmin("clickatel_user", isset($this->data['clickatel_user']) ? $this->data['clickatel_user'] : '');

            Yii::app()->functions->updateOptionAdmin("clickatel_password", isset($this->data['clickatel_password']) ? $this->data['clickatel_password'] : '');

            Yii::app()->functions->updateOptionAdmin("clickatel_api_id", isset($this->data['clickatel_api_id']) ? $this->data['clickatel_api_id'] : '');

            Yii::app()->functions->updateOptionAdmin("clickatel_use_curl", isset($this->data['clickatel_use_curl']) ? $this->data['clickatel_use_curl'] : '');

            Yii::app()->functions->updateOptionAdmin("nexmo_use_unicode", isset($this->data['nexmo_use_unicode']) ? $this->data['nexmo_use_unicode'] : '');

            Yii::app()->functions->updateOptionAdmin("clickatel_use_unicode", isset($this->data['clickatel_use_unicode']) ? $this->data['clickatel_use_unicode'] : '');

            Yii::app()->functions->updateOptionAdmin("clickatel_sender", isset($this->data['clickatel_sender']) ? $this->data['clickatel_sender'] : '');

            Yii::app()->functions->updateOptionAdmin("mechant_sms_purchase_disabled", isset($this->data['mechant_sms_purchase_disabled']) ? $this->data['mechant_sms_purchase_disabled'] : '');
            ...
            Yii::app()->functions->updateOptionAdmin("bhashsms_user", isset($this->data['bhashsms_user']) ? $this->data['bhashsms_user'] : '');

            Yii::app()->functions->updateOptionAdmin("bhashsms_pass", isset($this->data['bhashsms_pass']) ? $this->data['bhashsms_pass'] : '');

            Yii::app()->functions->updateOptionAdmin("bhashsms_senderid", isset($this->data['bhashsms_senderid']) ? $this->data['bhashsms_senderid'] : '');

            Yii::app()->functions->updateOptionAdmin("bhashsms_smstype", isset($this->data['bhashsms_smstype']) ? $this->data['bhashsms_smstype'] : '');

            Yii::app()->functions->updateOptionAdmin("bhashsms_priority", isset($this->data['bhashsms_priority']) ? $this->data['bhashsms_priority'] : '');

            Yii::app()->functions->updateOptionAdmin("bhashsms_use_curl", isset($this->data['bhashsms_use_curl']) ? $this->data['bhashsms_use_curl'] : '');

            Yii::app()->functions->updateOptionAdmin("smsglobal_senderid", isset($this->data['smsglobal_senderid']) ? $this->data['smsglobal_senderid'] : '');

            Yii::app()->functions->updateOptionAdmin("smsglobal_username", isset($this->data['smsglobal_username']) ? $this->data['smsglobal_username'] : '');

            Yii::app()->functions->updateOptionAdmin("smsglobal_password", isset($this->data['smsglobal_password']) ? $this->data['smsglobal_password'] : '');

            Yii::app()->functions->updateOptionAdmin("swift_accountkey", isset($this->data['swift_accountkey']) ? $this->data['swift_accountkey'] : '');

            Yii::app()->functions->updateOptionAdmin("swift_usecurl", isset($this->data['swift_usecurl']) ? $this->data['swift_usecurl'] : '');

            Yii::app()->functions->updateOptionAdmin("solutionsinfini_apikey", isset($this->data['solutionsinfini_apikey']) ? $this->data['solutionsinfini_apikey'] : '');

            Yii::app()->functions->updateOptionAdmin("solutionsinfini_usecurl", isset($this->data['solutionsinfini_usecurl']) ? $this->data['solutionsinfini_usecurl'] : '');

            Yii::app()->functions->updateOptionAdmin("solutionsinfini_useunicode", isset($this->data['solutionsinfini_useunicode']) ? $this->data['solutionsinfini_useunicode'] : '');

            Yii::app()->functions->updateOptionAdmin("solutionsinfini_sender", isset($this->data['solutionsinfini_sender']) ? $this->data['solutionsinfini_sender'] : '');


            Yii::app()->functions->updateOptionAdmin("plivo_auth_id", isset($this->data['plivo_auth_id']) ? $this->data['plivo_auth_id'] : '');

            Yii::app()->functions->updateOptionAdmin("plivo_auth_token", isset($this->data['plivo_auth_token']) ? $this->data['plivo_auth_token'] : '');

            Yii::app()->functions->updateOptionAdmin("plivo_sender_number", isset($this->data['plivo_sender_number']) ? $this->data['plivo_sender_number'] : '');

            Yii::app()->functions->updateOptionAdmin("msg91_authkey", isset($this->data['msg91_authkey']) ? $this->data['msg91_authkey'] : '');

            Yii::app()->functions->updateOptionAdmin("msg91_senderid", isset($this->data['msg91_senderid']) ? $this->data['msg91_senderid'] : '');

            Yii::app()->functions->updateOptionAdmin("msg91_unicode", isset($this->data['msg91_unicode']) ? $this->data['msg91_unicode'] : '');

            Yii::app()->functions->updateOptionAdmin("msg91_route", isset($this->data['msg91_route']) ? $this->data['msg91_route'] : '');
        ...
        public function payCC() {
            ...
            if ($this->data['type'] == "purchaseSMScredit") {
                ...
                if ($info = Yii::app()->functions->getSMSPackagesById($package_id)) {
                    ...
                    $this->msg = Yii::t("default", "Package information not found.");
            } else
                $this->msg = Yii::t("default", "Payment type is required");
        }
        ...
        public function SMSAlertSettings() {
            ...
            Yii::app()->functions->updateOption("sms_enabled_alert", isset($this->data['sms_enabled_alert']) ? $this->data['sms_enabled_alert'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("sms_notify_number", isset($this->data['sms_notify_number']) ? $this->data['sms_notify_number'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("sms_alert_message", isset($this->data['sms_alert_message']) ? $this->data['sms_alert_message'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("sms_alert_customer", isset($this->data['sms_alert_customer']) ? $this->data['sms_alert_customer'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("sms_alert_change_status", isset($this->data['sms_alert_change_status']) ? $this->data['sms_alert_change_status'] : ''
                    , $merchant_id);
        ...
        public function adminMercadoSettings() {
            Yii::app()->functions->updateOptionAdmin("admin_mercado_enabled", isset($this->data['admin_mercado_enabled']) ? $this->data['admin_mercado_enabled'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_mercado_mode", isset($this->data['admin_mercado_mode']) ? $this->data['admin_mercado_mode'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_mercado_id", isset($this->data['admin_mercado_id']) ? $this->data['admin_mercado_id'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_mercado_key", isset($this->data['admin_mercado_key']) ? $this->data['admin_mercado_key'] : '');
        ...
        public function merchantMercadoSettings() {
            ...
            Yii::app()->functions->updateOption("merchant_mercado_enabled", isset($this->data['merchant_mercado_enabled']) ? $this->data['merchant_mercado_enabled'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_mercado_mode", isset($this->data['merchant_mercado_mode']) ? $this->data['merchant_mercado_mode'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_mercado_id", isset($this->data['merchant_mercado_id']) ? $this->data['merchant_mercado_id'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_mercado_key", isset($this->data['merchant_mercado_key']) ? $this->data['merchant_mercado_key'] : '', $merchant_id);
            ...
            if ($validator->validate()) {
                ...
                if (!empty($this->data['id'])) {
                    ...
                    if ($res) {
                        ...
                        $this->msg = Yii::t("default", "ERROR: cannot updated.");
                } else {
            ...
            if (isset($this->data['voucher_code'])) {
                if ($res = Yii::app()->functions->getVoucherCodeNew($this->data['voucher_code'], $this->data['merchant_id'])) {
                    ...
                    if ($res = Yii::app()->functions->getVoucherCodeAdmin($this->data['voucher_code'])) {
                        ...
                        $this->msg = Yii::t("default", "Voucher code not found");
                }
            } else
                $this->msg = Yii::t("default", "Missing parameters");
        }
        ...
        public function geoReverse() {
            ...
            if ($resp) {
                ...
                $this->msg = Yii::t("default", "Failed response from google API");
        }
        ...
        public function setAddress() {
            if (isset($this->data['client_address'])) {
                ...
                $this->msg = Yii::t("default", "Address is required");
        }
        ...
        public function merchantPaylineSettings() {
            ...
            Yii::app()->functions->updateOption("merchant_payline_enabled", isset($this->data['merchant_payline_enabled']) ? $this->data['merchant_payline_enabled'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_payline_mode", isset($this->data['merchant_payline_mode']) ? $this->data['merchant_payline_mode'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_payline_api", isset($this->data['merchant_payline_api']) ? $this->data['merchant_payline_api'] : '', $merchant_id);
        ...
        public function adminPaylineSettings() {
            Yii::app()->functions->updateOptionAdmin("admin_payline_enabled", isset($this->data['admin_payline_enabled']) ? $this->data['admin_payline_enabled'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_payline_mode", isset($this->data['admin_payline_mode']) ? $this->data['admin_payline_mode'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_payline_api", isset($this->data['admin_payline_api']) ? $this->data['admin_payline_api'] : '');
        ...
        public function adminSisowSettings() {
            Yii::app()->functions->updateOptionAdmin("admin_sisow_enabled", isset($this->data['admin_sisow_enabled']) ? $this->data['admin_sisow_enabled'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_sisow_mode", isset($this->data['admin_sisow_mode']) ? $this->data['admin_sisow_mode'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_sanbox_sisow_secret_key", isset($this->data['admin_sanbox_sisow_secret_key']) ? $this->data['admin_sanbox_sisow_secret_key'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_sandbox_sisow_pub_key", isset($this->data['admin_sandbox_sisow_pub_key']) ? $this->data['admin_sandbox_sisow_pub_key'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_sandbox_sisow_shopid", isset($this->data['admin_sandbox_sisow_shopid']) ? $this->data['admin_sandbox_sisow_shopid'] : '');
        ...
        public function merchantSisowSettings() {
            ...
            Yii::app()->functions->updateOption("merchant_sisow_enabled", isset($this->data['merchant_sisow_enabled']) ? $this->data['merchant_sisow_enabled'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_sisow_mode", isset($this->data['merchant_sisow_mode']) ? $this->data['merchant_sisow_mode'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_sanbox_sisow_secret_key", isset($this->data['merchant_sanbox_sisow_secret_key']) ? $this->data['merchant_sanbox_sisow_secret_key'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_sandbox_sisow_pub_key", isset($this->data['merchant_sandbox_sisow_pub_key']) ? $this->data['merchant_sandbox_sisow_pub_key'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_sandbox_sisow_shopid", isset($this->data['merchant_sandbox_sisow_shopid']) ? $this->data['merchant_sandbox_sisow_shopid'] : ''
                    , $merchant_id);
        ...
        public function adminPayUMoney() {
            Yii::app()->functions->updateOptionAdmin("admin_payu_enabled", isset($this->data['admin_payu_enabled']) ? $this->data['admin_payu_enabled'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_payu_mode", isset($this->data['admin_payu_mode']) ? $this->data['admin_payu_mode'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_payu_key", isset($this->data['admin_payu_key']) ? $this->data['admin_payu_key'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_payu_salt", isset($this->data['admin_payu_salt']) ? $this->data['admin_payu_salt'] : '');
        ...
        public function merchantPayUMoney() {
            $merchant_id = Yii::app()->functions->getMerchantID();
            Yii::app()->functions->updateOption("merchant_payu_enabled", isset($this->data['merchant_payu_enabled']) ? $this->data['merchant_payu_enabled'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_payu_mode", isset($this->data['merchant_payu_mode']) ? $this->data['merchant_payu_mode'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_payu_key", isset($this->data['merchant_payu_key']) ? $this->data['merchant_payu_key'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_payu_salt", isset($this->data['merchant_payu_salt']) ? $this->data['merchant_payu_salt'] : '', $merchant_id);
        ...
        public function analyticsSetting() {
            ...
            Yii::app()->functions->updateOptionAdmin("admin_header_codes", isset($this->data['admin_header_codes']) ? $this->data['admin_header_codes'] : '');
        ...
        public function customerAdd() {
            ...
            if (isset($this->data['id']) && is_numeric($this->data['id'])) {
                unset($params['date_created']);
                $params['date_modified'] = date('c');
                $res = $command->update('{{client}}', $params, 'client_id=:client_id', array(':client_id' => addslashes($this->data['id'])));
                if ($res) {
                    $this->code = 1;
        ...
        public function bookingAlertSettings() {
            ...
            Yii::app()->functions->updateOption("merchant_booking_alert", isset($this->data['merchant_booking_alert']) ? $this->data['merchant_booking_alert'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_booking_approved_tpl", isset($this->data['merchant_booking_approved_tpl']) ? $this->data['merchant_booking_approved_tpl'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_booking_denied_tpl", isset($this->data['merchant_booking_denied_tpl']) ? $this->data['merchant_booking_denied_tpl'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_booking_subject", isset($this->data['merchant_booking_subject']) ? $this->data['merchant_booking_subject'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_booking_sender", isset($this->data['merchant_booking_sender']) ? $this->data['merchant_booking_sender'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_booking_receiver", isset($this->data['merchant_booking_receiver']) ? $this->data['merchant_booking_receiver'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_booking_tpl", isset($this->data['merchant_booking_tpl']) ? $this->data['merchant_booking_tpl'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_booking_receive_subject", isset($this->data['merchant_booking_receive_subject']) ? $this->data['merchant_booking_receive_subject'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("max_booked", isset($this->data['max_booked']) ? json_encode($this->data['max_booked']) : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("fully_booked_msg", isset($this->data['fully_booked_msg']) ? $this->data['fully_booked_msg'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("accept_booking_sameday", isset($this->data['accept_booking_sameday']) ? $this->data['accept_booking_sameday'] : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_table_booking", isset($this->data['merchant_table_booking']) ? $this->data['merchant_table_booking'] : ''
                    , $merchant_id);
        ...
        public function adminBankDeposit() {
            Yii::app()->functions->updateOptionAdmin("admin_bankdeposit_enabled", isset($this->data['admin_bankdeposit_enabled']) ? $this->data['admin_bankdeposit_enabled'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_deposit_instructions", isset($this->data['admin_deposit_instructions']) ? $this->data['admin_deposit_instructions'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_deposit_sender", isset($this->data['admin_deposit_sender']) ? $this->data['admin_deposit_sender'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_deposit_subject", isset($this->data['admin_deposit_subject']) ? $this->data['admin_deposit_subject'] : '');
        ...
        public function adminPayseraSettings() {
            Yii::app()->functions->updateOptionAdmin("admin_paysera_enabled", isset($this->data['admin_paysera_enabled']) ? $this->data['admin_paysera_enabled'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_paysera_mode", isset($this->data['admin_paysera_mode']) ? $this->data['admin_paysera_mode'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_paysera_project_id", isset($this->data['admin_paysera_project_id']) ? $this->data['admin_paysera_project_id'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_paysera_password", isset($this->data['admin_paysera_password']) ? $this->data['admin_paysera_password'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_paysera_lang", isset($this->data['admin_paysera_lang']) ? $this->data['admin_paysera_lang'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_paysera_country", isset($this->data['admin_paysera_country']) ? $this->data['admin_paysera_country'] : '');
        ...
        public function merchantPayseraSettings() {
            ...
            Yii::app()->functions->updateOption("merchant_paysera_enabled", isset($this->data['merchant_paysera_enabled']) ? $this->data['merchant_paysera_enabled'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_paysera_mode", isset($this->data['merchant_paysera_mode']) ? $this->data['merchant_paysera_mode'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_paysera_project_id", isset($this->data['merchant_paysera_project_id']) ? $this->data['merchant_paysera_project_id'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_paysera_password", isset($this->data['merchant_paysera_password']) ? $this->data['merchant_paysera_password'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_paysera_country", isset($this->data['merchant_paysera_country']) ? $this->data['merchant_paysera_country'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_paysera_lang", isset($this->data['merchant_paysera_lang']) ? $this->data['merchant_paysera_lang'] : '', $merchant_id);
        ...
        public function emailSettings() {
            ...
            Yii::app()->functions->updateOptionAdmin("smtp_host", isset($this->data['smtp_host']) ? $this->data['smtp_host'] : '');

            Yii::app()->functions->updateOptionAdmin("smtp_port", isset($this->data['smtp_port']) ? $this->data['smtp_port'] : '');

            Yii::app()->functions->updateOptionAdmin("smtp_username", isset($this->data['smtp_username']) ? $this->data['smtp_username'] : '');

            Yii::app()->functions->updateOptionAdmin("smtp_password", isset($this->data['smtp_password']) ? $this->data['smtp_password'] : '');

            Yii::app()->functions->updateOptionAdmin("email_provider", isset($this->data['email_provider']) ? $this->data['email_provider'] : '');

            Yii::app()->functions->updateOptionAdmin("mandrill_api_key", isset($this->data['mandrill_api_key']) ? $this->data['mandrill_api_key'] : '');
        ...
        public function emailTplSettings() {
            Yii::app()->functions->updateOptionAdmin("email_tpl_activation", isset($this->data['email_tpl_activation']) ? $this->data['email_tpl_activation'] : '');

            Yii::app()->functions->updateOptionAdmin("email_tpl_forgot", isset($this->data['email_tpl_forgot']) ? $this->data['email_tpl_forgot'] : '');

            Yii::app()->functions->updateOptionAdmin("email_tpl_customer_reg", isset($this->data['email_tpl_customer_reg']) ? $this->data['email_tpl_customer_reg'] : '');

            Yii::app()->functions->updateOptionAdmin("email_tpl_customer_subject", isset($this->data['email_tpl_customer_subject']) ? $this->data['email_tpl_customer_subject'] : '');
        ...
        public function paymentgatewaySettings() {
            Yii::app()->functions->updateOptionAdmin("paymentgateway", isset($this->data['paymentgateway']) ? json_encode($this->data['paymentgateway']) : '');
        ...
        public function gallerySettings() {
            ...
            Yii::app()->functions->updateOption("merchant_gallery", isset($this->data['photo']) ? json_encode($this->data['photo']) : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("gallery_disabled", isset($this->data['gallery_disabled']) ? $this->data['gallery_disabled'] : ''
                    , $merchant_id);
            ...
            if ($Validator->validate()) {
                ...
                if (isset($this->data['id']) && is_numeric($this->data['id'])) {
                    ...
                    if ($this->updateData("{{payment_provider}}", $params, 'id', $this->data['id'])) {
                        ...
                        $this->msg = t("ERROR: cannot update");
                } else {
        ...
        public function payOnDeliveryMerchant() {
            ...
            Yii::app()->functions->updateOption("payment_provider", isset($this->data['payment_provider']) ? json_encode($this->data['payment_provider']) : ''
                    , $merchant_id);

            Yii::app()->functions->updateOption("merchant_payondeliver_enabled", isset($this->data['merchant_payondeliver_enabled']) ? $this->data['merchant_payondeliver_enabled'] : ''
                    , $merchant_id);
        ...
        public function addOffers() {
            ...
            if (isset($this->data['id']) && is_numeric($this->data['id'])) {
                ...
                if (!Yii::app()->functions->getMerchantOffers($merchant_id, $this->data['valid_from'] . " 00:00:00", $this->data['valid_to'] . " 00:00:00", $this->data['id'])) {

                    unset($params['date_created']);
                    $params['date_modified'] = date('c');
                    $res = $command->update('{{offers}}', $params, 'offers_id=:offers_id', array(':offers_id' => addslashes($this->data['id'])));
                    if ($res) {
                        $this->code = 1;
                    ...
                    $this->msg = t("Already one offer is their in particular period of time.please delete or change the status to draft that offer then you can add another One offer");
            } else {
            ...
            if (isset($this->data['id'])) {
                if ($res = Yii::app()->functions->getMerchant($this->data['id'])) {
                    ...
                    if (!empty($merchant_email)) {
                        ...
                        $this->msg = t("Merchant has no email address provided");
                } else
                    $this->msg = t("Merchant information not found");
            } else
                $this->msg = t("Missing merchant id");
        }
        ...
        public function saveAdminBarclaySettings() {
            ...
            Yii::app()->functions->updateOptionAdmin("admin_enabled_barclay", isset($this->data['admin_enabled_barclay']) ? $this->data['admin_enabled_barclay'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_mode_barclay", isset($this->data['admin_mode_barclay']) ? $this->data['admin_mode_barclay'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_sandbox_barclay_pspid", isset($this->data['admin_sandbox_barclay_pspid']) ? $this->data['admin_sandbox_barclay_pspid'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_sandbox_barclay_password", isset($this->data['admin_sandbox_barclay_password']) ? $this->data['admin_sandbox_barclay_password'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_live_barclay_pspid", isset($this->data['admin_live_barclay_pspid']) ? $this->data['admin_live_barclay_pspid'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_live_barclay_password", isset($this->data['admin_live_barclay_password']) ? $this->data['admin_live_barclay_password'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_bcy_currency", isset($this->data['admin_bcy_currency']) ? $this->data['admin_bcy_currency'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_bcy_language", isset($this->data['admin_bcy_language']) ? $this->data['admin_bcy_language'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_bcy_font", isset($this->data['admin_bcy_font']) ? $this->data['admin_bcy_font'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_bcy_language", isset($this->data['admin_bcy_language']) ? $this->data['admin_bcy_language'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_bcy_bgcolor", isset($this->data['admin_bcy_bgcolor']) ? $this->data['admin_bcy_bgcolor'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_bcy_buttontextcolor", isset($this->data['admin_bcy_buttontextcolor']) ? $this->data['admin_bcy_buttontextcolor'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_bcy_table_bgcolor", isset($this->data['admin_bcy_table_bgcolor']) ? $this->data['admin_bcy_table_bgcolor'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_bcy_table_textcolor", isset($this->data['admin_bcy_table_textcolor']) ? $this->data['admin_bcy_table_textcolor'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_bcy_textcolor", isset($this->data['admin_bcy_textcolor']) ? $this->data['admin_bcy_textcolor'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_bcy_title", isset($this->data['admin_bcy_title']) ? $this->data['admin_bcy_title'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_bcy_buttoncolor", isset($this->data['admin_bcy_buttoncolor']) ? $this->data['admin_bcy_buttoncolor'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_bcy_listype", isset($this->data['admin_bcy_listype']) ? $this->data['admin_bcy_listype'] : '');

            Yii::app()->functions->updateOptionAdmin("admin_bcy_logo", isset($this->data['admin_bcy_logo']) ? $this->data['admin_bcy_logo'] : '');
        ...
        public function saveMerchantBarclaySettings() {
            ...
            Yii::app()->functions->updateOption("merchant_enabled_barclay", isset($this->data['merchant_enabled_barclay']) ? $this->data['merchant_enabled_barclay'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_mode_barclay", isset($this->data['merchant_mode_barclay']) ? $this->data['merchant_mode_barclay'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_sandbox_barclay_pspid", isset($this->data['merchant_sandbox_barclay_pspid']) ? $this->data['merchant_sandbox_barclay_pspid'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_sandbox_barclay_password", isset($this->data['merchant_sandbox_barclay_password']) ? $this->data['merchant_sandbox_barclay_password'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_live_barclay_pspid", isset($this->data['merchant_live_barclay_pspid']) ? $this->data['merchant_live_barclay_pspid'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_live_barclay_password", isset($this->data['merchant_live_barclay_password']) ? $this->data['merchant_live_barclay_password'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_bcy_currency", isset($this->data['merchant_bcy_currency']) ? $this->data['merchant_bcy_currency'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_bcy_language", isset($this->data['merchant_bcy_language']) ? $this->data['merchant_bcy_language'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_bcy_font", isset($this->data['merchant_bcy_font']) ? $this->data['merchant_bcy_font'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_bcy_language", isset($this->data['merchant_bcy_language']) ? $this->data['merchant_bcy_language'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_bcy_bgcolor", isset($this->data['merchant_bcy_bgcolor']) ? $this->data['merchant_bcy_bgcolor'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_bcy_buttontextcolor", isset($this->data['merchant_bcy_buttontextcolor']) ? $this->data['merchant_bcy_buttontextcolor'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_bcy_table_bgcolor", isset($this->data['merchant_bcy_table_bgcolor']) ? $this->data['merchant_bcy_table_bgcolor'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_bcy_table_textcolor", isset($this->data['merchant_bcy_table_textcolor']) ? $this->data['merchant_bcy_table_textcolor'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_bcy_textcolor", isset($this->data['merchant_bcy_textcolor']) ? $this->data['merchant_bcy_textcolor'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_bcy_title", isset($this->data['merchant_bcy_title']) ? $this->data['merchant_bcy_title'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_bcy_buttoncolor", isset($this->data['merchant_bcy_buttoncolor']) ? $this->data['merchant_bcy_buttoncolor'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_bcy_listype", isset($this->data['merchant_bcy_listype']) ? $this->data['merchant_bcy_listype'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_bcy_logo", isset($this->data['merchant_bcy_logo']) ? $this->data['merchant_bcy_logo'] : '', $merchant_id);
        ...
        public function saveAdminEpaybgSettings() {
            ...
            Yii::app()->functions->updateOption("admin_enabled_epaybg", isset($this->data['admin_enabled_epaybg']) ? $this->data['admin_enabled_epaybg'] : '');

            Yii::app()->functions->updateOption("admin_mode_epaybg", isset($this->data['admin_mode_epaybg']) ? $this->data['admin_mode_epaybg'] : '');

            Yii::app()->functions->updateOption("admin_sandbox_epaybg_min", isset($this->data['admin_sandbox_epaybg_min']) ? $this->data['admin_sandbox_epaybg_min'] : '');

            Yii::app()->functions->updateOption("admin_sandbox_epaybg_secret", isset($this->data['admin_sandbox_epaybg_secret']) ? $this->data['admin_sandbox_epaybg_secret'] : '');

            Yii::app()->functions->updateOption("admin_live_epaybg_min", isset($this->data['admin_live_epaybg_min']) ? $this->data['admin_live_epaybg_min'] : '');

            Yii::app()->functions->updateOption("admin_live_epaybg_secret", isset($this->data['admin_live_epaybg_secret']) ? $this->data['admin_live_epaybg_secret'] : '');

            Yii::app()->functions->updateOption("admin_sandbox_epaybg_request", isset($this->data['admin_sandbox_epaybg_request']) ? $this->data['admin_sandbox_epaybg_request'] : '');

            Yii::app()->functions->updateOption("admin_sandbox_epaybg_lang", isset($this->data['admin_sandbox_epaybg_lang']) ? $this->data['admin_sandbox_epaybg_lang'] : '');

            Yii::app()->functions->updateOption("admin_live_epaybg_request", isset($this->data['admin_live_epaybg_request']) ? $this->data['admin_live_epaybg_request'] : '');
            Yii::app()->functions->updateOption("admin_live_epaybg_lang", isset($this->data['admin_live_epaybg_lang']) ? $this->data['admin_live_epaybg_lang'] : '');
        ...
        public function saveMerchantEpaybgSettings() {
            ...
            Yii::app()->functions->updateOption("merchant_enabled_epaybg", isset($this->data['merchant_enabled_epaybg']) ? $this->data['merchant_enabled_epaybg'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_mode_epaybg", isset($this->data['merchant_mode_epaybg']) ? $this->data['merchant_mode_epaybg'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_sandbox_epaybg_min", isset($this->data['merchant_sandbox_epaybg_min']) ? $this->data['merchant_sandbox_epaybg_min'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_sandbox_epaybg_secret", isset($this->data['merchant_sandbox_epaybg_secret']) ? $this->data['merchant_sandbox_epaybg_secret'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_live_epaybg_min", isset($this->data['merchant_live_epaybg_min']) ? $this->data['merchant_live_epaybg_min'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_live_epaybg_secret", isset($this->data['merchant_live_epaybg_secret']) ? $this->data['merchant_live_epaybg_secret'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_sandbox_epaybg_request", isset($this->data['merchant_sandbox_epaybg_request']) ? $this->data['merchant_sandbox_epaybg_request'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_live_epaybg_request", isset($this->data['merchant_live_epaybg_request']) ? $this->data['merchant_live_epaybg_request'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_sandbox_epaybg_lang", isset($this->data['merchant_sandbox_epaybg_lang']) ? $this->data['merchant_sandbox_epaybg_lang'] : '', $merchant_id);

            Yii::app()->functions->updateOption("merchant_live_epaybg_lang", isset($this->data['merchant_live_epaybg_lang']) ? $this->data['merchant_live_epaybg_lang'] : '', $merchant_id);
        ...
        public function themeSettings() {
            ...
            Yii::app()->functions->updateOptionAdmin("theme_hide_logo", isset($this->data['theme_hide_logo']) ? $this->data['theme_hide_logo'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_hide_how_works", isset($this->data['theme_hide_how_works']) ? $this->data['theme_hide_how_works'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_hide_cuisine", isset($this->data['theme_hide_cuisine']) ? $this->data['theme_hide_cuisine'] : '');
            ...
            Yii::app()->functions->updateOptionAdmin("theme_custom_footer", isset($this->data['theme_custom_footer']) ? $this->data['theme_custom_footer'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_show_app", isset($this->data['theme_show_app']) ? $this->data['theme_show_app'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_app_android", isset($this->data['theme_app_android']) ? $this->data['theme_app_android'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_app_ios", isset($this->data['theme_app_ios']) ? $this->data['theme_app_ios'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_app_windows", isset($this->data['theme_app_windows']) ? $this->data['theme_app_windows'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_filter_colapse", isset($this->data['theme_filter_colapse']) ? $this->data['theme_filter_colapse'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_list_style", isset($this->data['theme_list_style']) ? $this->data['theme_list_style'] : '');

            Yii::app()->functions->updateOptionAdmin("enabled_search_map", isset($this->data['enabled_search_map']) ? $this->data['enabled_search_map'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_menu_colapse", isset($this->data['theme_menu_colapse']) ? $this->data['theme_menu_colapse'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_top_menu", isset($this->data['theme_top_menu']) ? json_encode($this->data['theme_top_menu']) : '');

            Yii::app()->functions->updateOptionAdmin("show_language", isset($this->data['show_language']) ? $this->data['show_language'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_promo_tab", isset($this->data['theme_promo_tab']) ? $this->data['theme_promo_tab'] : '');

            Yii::app()->functions->updateOptionAdmin("merchant_tbl_book_disabled", isset($this->data['merchant_tbl_book_disabled']) ? $this->data['merchant_tbl_book_disabled'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_hours_tab", isset($this->data['theme_hours_tab']) ? $this->data['theme_hours_tab'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_reviews_tab", isset($this->data['theme_reviews_tab']) ? $this->data['theme_reviews_tab'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_map_tab", isset($this->data['theme_map_tab']) ? $this->data['theme_map_tab'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_info_tab", isset($this->data['theme_info_tab']) ? $this->data['theme_info_tab'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_photos_tab", isset($this->data['theme_photos_tab']) ? $this->data['theme_photos_tab'] : '');

            Yii::app()->functions->updateOptionAdmin("cookie_law_enabled", isset($this->data['cookie_law_enabled']) ? $this->data['cookie_law_enabled'] : '');
            Yii::app()->functions->updateOptionAdmin("cookie_accept_text", isset($this->data['cookie_accept_text']) ? $this->data['cookie_accept_text'] : '');
            Yii::app()->functions->updateOptionAdmin("cookie_info_text", isset($this->data['cookie_info_text']) ? $this->data['cookie_info_text'] : '');
            Yii::app()->functions->updateOptionAdmin("cookie_msg_text", isset($this->data['cookie_msg_text']) ? $this->data['cookie_msg_text'] : '');
            Yii::app()->functions->updateOptionAdmin("cookie_info_link", isset($this->data['cookie_info_link']) ? $this->data['cookie_info_link'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_search_merchant_name", isset($this->data['theme_search_merchant_name']) ? $this->data['theme_search_merchant_name'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_search_street_name", isset($this->data['theme_search_street_name']) ? $this->data['theme_search_street_name'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_search_cuisine", isset($this->data['theme_search_cuisine']) ? $this->data['theme_search_cuisine'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_search_foodname", isset($this->data['theme_search_foodname']) ? $this->data['theme_search_foodname'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_compression", isset($this->data['theme_compression']) ? $this->data['theme_compression'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_search_merchant_address", isset($this->data['theme_search_merchant_address']) ? $this->data['theme_search_merchant_address'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_lang_pos", isset($this->data['theme_lang_pos']) ? $this->data['theme_lang_pos'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_hide_footer_section1", isset($this->data['theme_hide_footer_section1']) ? $this->data['theme_hide_footer_section1'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_hide_footer_section2", isset($this->data['theme_hide_footer_section2']) ? $this->data['theme_hide_footer_section2'] : '');

            Yii::app()->functions->updateOptionAdmin("theme_time_pick", isset($this->data['theme_time_pick']) ? $this->data['theme_time_pick'] : '');

...
{	
	...
	public function merchantMenu()
	{
		...
		$payment_list=array('visible'=>$this->hasMerchantAccess("payment-gateway"),'tag'=>'payment-gateway','label'=>'<i class="fa fa-usd"></i>'.Yii::t("default",'Payment Gateway'),
                   ...
                   array('visible'=>$this->hasMerchantAccess("paypal"),'tag'=>'paypal', 'label'=>'<i class="fa fa-paypal"></i>'.Yii::t("default","Paypal"),                    
                   'url'=>array('merchant/paypalSettings')),                
                   
                   array('visible'=>$this->hasMerchantAccess("stripe"),'tag'=>'stripe', 'label'=>'<i class="fa fa-paypal"></i>'.Yii::t("default","Stripe"),                    
                   'url'=>array('merchant/stripeSettings')),                
                   
                   array('visible'=>$this->hasMerchantAccess("mercadopago"),'tag'=>'mercadopago', 'label'=>'<i class="fa fa-paypal"></i>'.Yii::t("default","Mercadopago"), 
...
'sub_item_name',$addon_name_trans)).'</div>';
		        ...
		        $htm.='<div class="summary-wrap">';
		         ...
		         if ( $has_voucher==TRUE){		 
			         ...
			         if($pts_redeem_amt>0){
				         $htm.='<div class="a">'.t("Points Discount").':</div>';
				         $htm.='<div class="manage">';
				           $htm.='<div class="b">('.PointsProgram::price($pts_redeem_amt).')</div>';
				         $htm.='</div>';		
			         } */
...
function qTranslate($text='',$key='',$data='')
{		
	if (Yii::app()->functions->getOptionAdmin("enabled_multiple_translation")!=2){

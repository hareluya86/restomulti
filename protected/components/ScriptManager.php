...
class ScriptManager {
    ...
    public static function RegisterAllCoreJSFile() {
        $baseUrl = Yii::app()->baseUrl;
        $cs = Yii::app()->getClientScript();
        ...
        $cs->registerScriptFile("//code.jquery.com/ui/1.10.2/jquery-ui.js"
                , CClientScript::POS_END);
        ...
        $cs->registerScript(
                'front_ajax', "var front_ajax ='" . Yii::app()->request->baseUrl . "/ajax' ", CClientScript::POS_HEAD
        );
        ...
        $cs->registerScript(
                'home_url', "var home_url ='" . Yii::app()->createUrl('/store') . "' ", CClientScript::POS_HEAD
        );

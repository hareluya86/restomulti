...
<div class="row bottom10">
  ...
  <div class="col-md-6 form-group">
	...
	,
	array(
	'class'=>'grey-fields full-width numeric_only form-control',
	'data-validation'=>"required",
	'maxlength'=>16
	));
	?>
...
<div class="row top10">
  <div class="col-md-12">  
  <button type="submit" class="btn_1"><?php echo t("Save")?></button>
    <a class="btn_listing" href="<?php echo Yii::app()->createUrl('/store/profile/?tab=4')?>">

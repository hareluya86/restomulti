...
class StoreController extends CController {
    ...
    public function actionCuisine() {
        ...
        $res = FunctionsV3::searchByMerchant(
                        'kr_search_category', isset($_GET['st']) ? $_GET['st'] : '', isset($_GET['page']) ? $_GET['page'] : 0, FunctionsV3::getPerPage(), $_GET
        );
            ...
            switch ($_GET['do']) {
                ...
                case "step3b":
                    if (isset($_GET['gateway'])) {
                        ...
                        $this->render('merchant-signup-step3b');
                    break;
                ...
                case "step4":
                    ...
                    if ($disabled_verification == "yes") {
                        ...
                        if ($package_info = FunctionsV3::getMerchantPaymentMembership($merchant['merchant_id'], $merchant['package_id'])) {
    ...
    public function actionContact() {
        ...
        $cs = Yii::app()->getClientScript();
        $cs->registerScript(
                'website_location', 'var website_location = ' . json_encode($website_map_location) . '
		  ', CClientScript::POS_HEAD
        );
    ...
    public function actionSearchArea() {
        ...
        switch ($_SESSION['search_type']) {
            case "kr_search_address":
                if (isset($_GET['s'])) {
                    $res = FunctionsV3::searchByAddress(
                                    isset($_GET['s']) ? $_GET['s'] : '', isset($_GET['page']) ? $_GET['page'] : 0, FunctionsV3::getPerPage(), $_GET
                    );
                }
            ...
            case "kr_search_restaurantname":
                $res = FunctionsV3::searchByMerchant(
                                $_SESSION['search_type'], isset($_GET['st']) ? $_GET['st'] : '', isset($_GET['page']) ? $_GET['page'] : 0, FunctionsV3::getPerPage(), $_GET
                );
                $current_page_url = Yii::app()->createUrl('store/searcharea/', array(
    ...
    public function actionLogout() {
        ...
        if (!empty($http_referer)) {
            ...
            header("Location: " . Yii::app()->createUrl('/store'));
    }
    ...
    public function actionforgotPassword() {
        if ($res = Yii::app()->functions->getLostPassToken($_GET['token'])) {
            ...
            $this->render('error', array('message' => t("ERROR: Invalid token.")));
    }
                ...
                if ($data['do'] == "accept") {
                    ...
                    switch ($res['transaction_type']) {
                        ...
                        case "signup":
                            ...
                            $db_ext->updateData("{{merchant}}", array(
                                'payment_steps' => 3,
    ...
    public function actionMerchantSignupSelection() {
        ...
        if (Yii::app()->functions->getOptionAdmin("merchant_disabled_registration") == "yes") {
            ...
            $this->render('merchant-signup-selection', array(
                ...
                case "order":
                    ...
                    if ($res = $db_ext->rst($stmt)) {
                        ...
                        if ($res['trans_type'] == "pickup") {
                            ...
                            $customer_number = $res['contact_phone'];
